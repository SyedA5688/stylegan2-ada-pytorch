...
def is_image_ext(fname: Union[str, Path]) -> bool:
    ...
    return f'.{ext}' in Image.EXTENSION # type: ignore
            ...
            for idx, (_key, value) in enumerate(txn.cursor()):
                try:
                    try:
                        ...
                        img = np.array(Image.open(io.BytesIO(value)))
...
def make_transform(
    ...
    resample = { 'box': Image.BOX, 'lanczos': Image.LANCZOS }[resize_filter]
    print("Transform is", transform, "inside of make_transform()")
